...
| 3 | `room` | [Room.java](file:///c:/Users/quang/Documents/datn/Shiina/KollaMeeting/backend/src/main/java/com/example/kolla/models/Room.java) | Quản lý danh sách các phòng họp; `RoomCode` và liên kết `Department_id` là bắt buộc theo schema Word. |
