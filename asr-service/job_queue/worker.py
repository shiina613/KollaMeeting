"""
Kolla ASR Service - Background Queue Worker
...
from core.recognizer import GipformerRecognizer, PhoWhisperRecognizer, get_recognizer
...
class TranscriptionWorker:
    ...
    Args:
        ...
        recognizer: Optional pre-loaded recognizer singleton.
    ...
    def __init__(
        ...
        recognizer: Optional[GipformerRecognizer | PhoWhisperRecognizer] = None,
    ) -> None:
    ...
    def _process_job(self, job: Dict[str, Any]) -> None:
        ...
        # Do not delete audio_path here — Spring Boot stores the same path for
        # "Nghe lại" playback in MeetingDetailPage. Files live under the shared
        # app-storage volume (/app/storage/audio_chunks/...).

    # ------------------------------------------------------------------
    # Recognizer accessor
    # ------------------------------------------------------------------

    def _get_recognizer(self) -> GipformerRecognizer | PhoWhisperRecognizer:
